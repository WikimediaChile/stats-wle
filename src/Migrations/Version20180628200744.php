 ...
 */
final class Version20180628200744 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users_commons ADD COLUMN is_new BOOLEAN');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__foto');
        $this->addSql('CREATE INDEX idx_foto ON foto (pageid)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__users_commons AS SELECT id, username, date_create FROM users_commons');
        ...
        $this->addSql('INSERT INTO users_commons (id, username, date_create) SELECT id, username, date_create FROM __temp__users_commons');
